                  ...
                  <nav className="home-links" aria-label="HVNT33 links">
                    ...
                    <button data-label="Community" onClick={() => void openExternal("https://discord.gg/Y22TyQAQmu")} aria-label="Community">
                      <svg className="discord-mark" viewBox="0 0 24 24" aria-hidden="true">
                        <path className="brand-fill" d="M8.1 7.2A10.6 10.6 0 0 1 12 6.5c1.4 0 2.7.2 3.9.7l.8-1.5c1.6.4 3.1 1.2 4.2 2.2.8 3 .8 5.9 0 8.7a13.2 13.2 0 0 1-4.8 2.5l-1.2-1.6c.7-.3 1.4-.6 2-1.1-3 1.3-6.8 1.3-9.8 0 .6.5 1.3.8 2 1.1l-1.2 1.6a13.2 13.2 0 0 1-4.8-2.5 17.2 17.2 0 0 1 0-8.7 12.6 12.6 0 0 1 4.2-2.2l.8 1.5Z"/>
                        <circle className="brand-cutout" cx="8.7" cy="12.6" r="1.15"/><circle className="brand-cutout" cx="15.3" cy="12.6" r="1.15"/>
                      </svg>
                    </button>
                    <button data-label="Source Code" onClick={() => void openExternal("https://github.com/kai-ten/hvnt33")} aria-label="Source Code">
                      <svg viewBox="0 0 24 24" aria-hidden="true"><path className="brand-fill" d="M12 2.8a9.2 9.2 0 0 0-2.9 17.9c.5.1.6-.2.6-.5v-1.8c-2.7.6-3.3-1.1-3.3-1.1-.4-1.1-1.1-1.4-1.1-1.4-.9-.6.1-.6.1-.6 1 0 1.5 1 1.5 1 .9 1.5 2.3 1.1 2.9.8.1-.6.3-1.1.6-1.4-2.2-.2-4.5-1.1-4.5-4.6 0-1 .4-1.9 1-2.5-.1-.3-.4-1.3.1-2.5 0 0 .8-.3 2.6 1a9 9 0 0 1 4.8 0c1.8-1.3 2.6-1 2.6-1 .5 1.2.2 2.2.1 2.5.6.6 1 1.5 1 2.5 0 3.5-2.3 4.4-4.5 4.6.4.3.7.9.7 1.8v2.5c0 .3.2.6.7.5A9.2 9.2 0 0 0 12 2.8Z"/></svg>
                    </button>
                  </nav>
                </div>
              )}
