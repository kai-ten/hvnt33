...
export default defineConfig({
  ...
  webServer: [
    { command: "node tests/fake-resend.ts --port 4421", url: "http://127.0.0.1:4421/_calls", reuseExistingServer: false },
    {
      ...
      env: { RESEND_API_KEY: "re_test", RESEND_SEGMENT_ID: "seg_test", NEWSLETTER_FROM: "HVNT33 <test@hvnt33.com>", NEWSLETTER_SECRET: "test-secret", SITE_URL: "http://127.0.0.1:4420", RESEND_API_URL: "http://127.0.0.1:4421" },
    },
  ],
});
